...
# compatible with the following processes. Due to this data cleaning we removed 
# 6 rows from the dataframe - we decided to delete each row with some NAs, 
# there were just 6 NAs, all of one symbol. 
